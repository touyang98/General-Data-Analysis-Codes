...
The std_conc function (inspired by Dr. Jeremy Schreier jschreier@umces.edu) aims to automatically identify standard concentrations that will be used for calibration curve development. 
...
The plot_cal function is used to plot the calibration curve with linear fitted calibration curve equation shown.
```{r}
...
```
## Determine the [NPOC] and [TDN] in water samples using the developed calibration curves 
```{r}
##determine the [NPOC] 
