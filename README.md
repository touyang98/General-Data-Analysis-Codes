...
| [`iCAP_ProSeries_ICP-OES/`](iCAP_ProSeries_ICP-OES/) | Thermo Scientific iCAP Pro Series ICP-OES output | Not currently available                                                      | Read SpreadsheetML/XML exports, extract instrumental signals, select an ion and signal column, fit a calibration curve, and calculate dilution-corrected concentrations                                              |
