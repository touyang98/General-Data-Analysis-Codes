...
| [`iCAP_ProSeries_ICP-OES/`](iCAP_ProSeries_ICP-OES/) | Thermo Scientific iCAP Pro Series ICP-OES output | [`ICP-OES_Cations_Analysis.md`](iCAP_ProSeries_ICP-OES/ICP-OES_Cations_Analysis.md)                                                      | Read SpreadsheetML/XML exports, extract instrumental signals, select an ion and signal column, fit a calibration curve, and calculate dilution-corrected concentrations                                              |
